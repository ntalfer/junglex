defmodule Junglex.Exercise3Test do
 ...
 %{"contract_type" => "FULL_TIME", "distance" => 0.0,
   ...
   "office_latitude" => "25.2048493", "office_longitude" => "55.2707828",
   "profession_id" => "9"},
 %{"contract_type" => "FULL_TIME", "distance" => 2725.932464965934,
 ...
 %{"contract_type" => "FULL_TIME", "distance" => 0.0, "name" => "IT Director",
   ...
   "profession_id" => "17"}]
    ...
    assert Junglex.Exercise3.process(25.2048493,55.2707828, 10_000) == expected
  end
 ...
 %{"contract_type" => "FULL_TIME", "distance" => 0.0, "name" => "IT Director",
   ...
   "profession_id" => "17"}]
    ...
    assert Junglex.Exercise3.process(25.2048493,55.2707828, 1_000) == expected
  end
